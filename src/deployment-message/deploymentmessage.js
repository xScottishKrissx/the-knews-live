...
export const MessageBody = () =>{
    return(
        ...
        <div>
            <h1>theKnews </h1>
            <h3>Deployed Version 12.10.4 - liteKnews Update - 2/7/2021</h3>
            ...
            <hr />
            <p>Notice: 12.10.4 is the fourth in a series of updates to theKnews focused on reworking the User Interface across the entire project. As a result some things may not look "right" and other things might appear out of place. This release focuses on improving the appearance of liteKnews.</p>
            ...
            <p>Potential Issue - Edge(91.0.864.48) - If you get a blank page on load, hit the full website reset button in the options menu from the home page. This might solve the problem.</p>
            ...
            <p>Tip: The "Full Website Reset" button in the options menu on the home page is your friend. This is very much a WIP and, while I do try my best to make sure there are 0 bugs and everything works, I can't guarantee you won't see a blank page or elements doing things you wouldn't expect. </p>
